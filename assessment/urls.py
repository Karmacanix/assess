...
urlpatterns = [
    ...
    path('CAT/<int:pk>/update/', views.CatMeetingDetail.as_view(), name='catmeeting-detail'),
    path('CAT/<int:pk/delete/', views.CatMeetingList.as_view(), name='catmeeting-delete'),
