...
urlpatterns = [
    ...
    path('CAT/', views.CatMeetingDetailView.as_view(), name='cat-meeting-detail'),
    ...
    path('governance/', views.GovernanceMeetings.as_view(), name='governance-meetings'),
    ...
    path('IPSG/', views.IPSGMeetingDetailView.as_view(), name='ipsg-meeting-detail'),
